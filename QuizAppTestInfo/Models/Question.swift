...
enum Game: Character {
    ...
    var definition: String {
        switch self {
        case .alias:
            return "Элиас: цель игроков — объяснять друг другу слова"
        case .bombCats:
            return "Взрывные котята: Милые пушистики смертельно опасны!"
        case .bang:
            return "Бэнг: Дикий Запад не просто так называют диким, ведь на нём творятся воистину дикие вещи в самых диких проявлениях дикости :)"
        case .mafia:
            return "Маифя: клубная командная психологическая пошаговая ролевая игра с детективным сюжетом, моделирующая борьбу информированных друг о друге членов организованного меньшинства с неорганизованным большинством."
        }
    }
}
